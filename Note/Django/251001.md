...
#### ![alt text](image/image1001-4.png)
...
#### ![alt text](image/image1001-7.png)
### UserCreationForm()
...
#### ![alt text](image/image1001-10.png)
...
#### ![alt text](image/image1001-15.png)
...
#### ![alt text](image/image1001-18.png)
# 참고
## is_authenticated 코드
- 메서드가 아닌 속성 값임을 주의
## 회원가입 후 자동 로그인
